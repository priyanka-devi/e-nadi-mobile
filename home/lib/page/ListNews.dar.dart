                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Image(
                            fit: BoxFit.fill,
                            image: NetworkImage((listNews as dynamic)[index]
                                ['fields']['image']),
                          ),
                        ),
                        ListTile(
                          title: Text(
                              (listNews as dynamic)[index]['fields']['title']),
                          subtitle: Text((listNews as dynamic)[index]['fields']
                              ['thumbnail']),
                        ),
                        Row(
                          children: <Widget>[
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => Details(
                                      title: (listNews as dynamic)[index]
                                          ['fields']['title'],
                                      image: (listNews as dynamic)[index]
                                          ['fields']['image'],
                                      intro: (listNews as dynamic)[index]
                                          ['fields']['intro'],
                                      news: (listNews as dynamic)[index]
                                          ['fields']['news'],
                                      thumbnail: (listNews as dynamic)[index]
                                          ['fields']['thumbnail'],
                                    ),
                                  ),
                                );
